...
/**
 * Caches one composite (non-leaf) [IElementType] per (grammar id, nonterminal name) pair: the PSI
 * node type a reduced production's nonterminal becomes, mirroring [AlpacaTokenTypes] for leaf
