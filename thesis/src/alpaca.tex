...
\begin{document}
    ...
    Specyfikacja analizy leksykalnej opiera się na wyrażeniach regularnych, co wykorzystuje powszechnie znany mechanizm, ograniczając próg wejścia i wspierając praktyczną adopcję narzędzia.
    ...
    Reprezentacja grafowa umożliwia ponadto wnioskowanie o relacjach przechodnich, co pozwala na automatyczne rozwiązywanie konfliktów wynikających z pośrednich zależności precedencji.
    Walidacja empiryczna porównuje bibliotekę ALPACA z alternatywnymi narzędziami w testach wydajnościowych obejmujących parsowanie wyrażeń arytmetycznych oraz plików w formacie JSON.
