...
\begin{document}
    ...
    Walidacja empiryczna porównuje rozwiązanie z innymi narzędziami za pomocą testów wydajnościowych, które obejmują wyrażenia arytmetyczne oraz parsowanie JSON. Wyniki wykazują wydajność konkurencyjną wobec konkurenyjncyh rozwiązań dla struktur iteracyjnych i utrzymaniu stabilnej wydajności przy głębokim zagnieżdżeniu.
    Implementacja wykazując poprawę użyteczności w porównaniu do wszystkich analizowanych alternatyw.
    ...
    Results demonstrate performance competitive with the other tools.
    The solution demonstrating improved usability compared to all analyzed alternatives.
