...
\lstinputlisting[language=scala,caption={Użycie mechanizmu Empty[T]},label={lst:impl-20-utils-empty-usage}]{listings/implementation/lexer-09-empty-usage.scala}
