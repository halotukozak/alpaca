...
\subsubsection{Klasa replacerefs}\label{subsubsec:impl-lexer-replacerefs}
...
\subsubsection{Konstrukcja symbolu klasy}\label{subsubsec:impl-lexer-symbol}
...
\subsubsection{Definicja członków klasy}\label{subsubsec:impl-lexer-members}
...
\subsubsection{Materializacja klasy}\label{subsubsec:impl-lexer-materialization}
...
\lstinputlisting[language=scala,caption={Klasa bazowa Parser},label={lst:impl-parser-base},linerange={19-24}]{listings/implementation/parser-01-base.scala}
...
\subsubsection{Makro createTablesImpl}\label{subsubsec:impl-parser-macro}
...
\subsubsection{Ekstrakcja produkcji z wzorców}\label{subsubsec:impl-parser-extraction}
...
\subsubsection{Implementacja ToExpr dla złożonych struktur}\label{subsubsec:impl-toexpr}
...
\lstinputlisting[language=scala,caption={Definicja klasy typu Empty[T]},label={lst:impl-19-utils-empty}]{listings/implementation/lexer-08-empty.scala}
...
\lstinputlisting[language=scala,caption={Użycie Empty[T]},label={lst:impl-20-utils-empty-usage}]{listings/implementation/lexer-09-empty-usage.scala}
...
\lstinputlisting[language=scala,caption={Definicja klasy typu Copyable[T]},label={lst:impl-25-utils-copyable}]{listings/implementation/lexer-10-copyable.scala}
...
\lstinputlisting[language=scala,caption={Użycie Copyable[T]},label={lst:impl-26-utils-copyable-usage}]{listings/implementation/lexer-11-copyable-usage.scala}
