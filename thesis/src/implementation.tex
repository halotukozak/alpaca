...
Kluczową techniką jest zastąpienie referencji do starego kontekstu nowymi referencjami za pomocą klasy \verb|ReplaceRefs|.
...
Derywacja instancji~\verb|Empty[T]| wykorzystuje mechanizm~\verb|Mirror| wprowadzony w~Scali~3~\cite{scala3-derivation}, który umożliwia generyczną introspekcję typów produktowych w~czasie kompilacji.
