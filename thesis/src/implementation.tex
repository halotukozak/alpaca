...
\lstinputlisting[language=scala,caption={Podejście oparte na mapowaniu dynamicznym},label={lst:lstlisting-dynamic-mapping}]{listings/implementation/lstlisting-dynamic-mapping.scala}
...
\lstinputlisting[language=scala,caption={Podejście oparte na jawnej definicji klasy},label={lst:lstlisting-explicit-lexer}]{listings/implementation/lstlisting-explicit-lexer.scala}
...
\lstinputlisting[language=scala,caption={Definicja klasy typu Empty[T]}]{listings/implementation/code_6.scala}
...
\lstinputlisting[language=scala,caption={Użycie Empty[T]}]{listings/implementation/code_7.scala}
...
\lstinputlisting[language=scala,caption={Definicja klasy typu Copyable[T]}]{listings/implementation/code_12.scala}
...
\lstinputlisting[language=scala,caption={Użycie Copyable[T]}]{listings/implementation/code_13.scala}
