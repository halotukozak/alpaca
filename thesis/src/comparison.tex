...
Dla przypadku 2000~elementów system~\textit{ALPACA} nie zakończył pomiaru w~akceptowalnym czasie (oznaczono jako~---).
...
Czas leksykalizacji rośnie nieproporcjonalnie do~rozmiaru danych, co~wymaga dalszej analizy i~optymalizacji (sekcja~\ref{subsec:wnioski}).
...
\label{subsec:kierunki-dalszych-prac}
