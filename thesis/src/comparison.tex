...
\begin{itemize}
    \item Procesor: Apple M4 Pro, 14 rdzeni
    \item Pamięć RAM: 48 GB
    \item System operacyjny: macOS Sequoia 15.6
    \item JVM: OpenJDK 21.0.8
    \item Python: 3.13.5
    \item Scala: 3.8.0-RC1
\end{itemize}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{l|*{3}{Y}|*{3}{Y}|Y}
        ...
        2000                              & 220,96~ms                            & 25,82~ms                          & 274,95~ms          & 43,06~ms & 150,68~ms & 194,77~ms & $\dagger$ \\
        \bottomrule
    \end{tabularx}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{l|*{3}{Y}|*{3}{Y}|Y}
        ...
        2000                              & \textsuperscript{*}                  & \textsuperscript{*}               & \textsuperscript{*} & 5,26~s    & 385,47~ms & 5,79~s    & 346,44~ms \\
        \bottomrule
    \end{tabularx}
