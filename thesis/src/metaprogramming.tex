...
\lstinputlisting[language=Scala,caption={Proste makro z wykorzystaniem cytatów i~wstawek},label={lst:meta-quotes-example}]{listings/metaprogramming/meta-quotes-example.scala}
...
\lstinputlisting[language=Scala,caption={Błąd bezpieczeństwa międzyetapowego (kod nie kompiluje się)},label={lst:meta-cross-stage-error}]{listings/metaprogramming/meta-cross-stage-error.scala}
...
\lstinputlisting[language=Scala,caption={Poprawne przeniesienie wartości między etapami},label={lst:meta-cross-stage-correct}]{listings/metaprogramming/meta-cross-stage-correct.scala}
...
\lstinputlisting[language=Scala,caption={Użycie modyfikatora inline dla optymalizacji},label={lst:meta-inline-example}]{listings/metaprogramming/meta-inline-example.scala}
...
\lstinputlisting[language=Scala,caption={Makro generujące kod inspekcji typu},label={lst:meta-macro-example}]{listings/metaprogramming/meta-macro-example.scala}
...
\lstinputlisting[language=Scala,caption={Optymalizacja wyrażeń algebraicznych poprzez dopasowanie wzorców},label={lst:meta-pattern-matching}]{listings/metaprogramming/meta-pattern-matching.scala}
...
\lstinputlisting[language=Scala,caption={Inspekcja struktury klasy przypadku za pomocą refleksji TASTy},label={lst:meta-tasty-reflection}]{listings/metaprogramming/meta-tasty-reflection.scala}
