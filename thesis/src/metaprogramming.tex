...
\subsection{Template Haskell}\label{subsec:template-haskell}
...
\subsection[Makra w Rust]{Makra w~Rust}\label{subsec:makra-wrust}
...
\begin{enumerate}
    ...
    \item \textbf{Transformacja AST} (sekcja~\ref{subsubsec:transformacja-i-adaptacja-referencji}) --- przepisywanie właścicieli symboli (\emph{re-owning}) poprzez \verb|ReplaceRefs|
