...
\begin{itemize}
    \item Generacja klas anonimowych (sekcja~\ref{subsec:impl-lexer-anon-class}) --- wykorzystanie \verb|Symbol.newClass| do~programatycznego tworzenia typów w~czasie kompilacji

    \item Transformacja AST (sekcja~\ref{subsubsec:impl-lexer-refs}) --- przepisywanie właścicieli symboli (\emph{re-owning}) poprzez \verb|ReplaceRefs|
    ...
    \item Walidacja w~czasie kompilacji (sekcja~\ref{subsec:impl-errors}) --- wykrywanie błędów gramatyki przed wykonaniem programu
\end{itemize}
