...
Dzięki temu rozwiązaniu użytkownik może zadeklarować jedynie podstawowe reguły precedencji (np.~$\textit{mnożenie} \prec \textit{dodawanie}$, gdzie~$\prec$ oznacza wyższy priorytet), a~system automatycznie wyprowadzi wszystkie implikacje przechodnie.
...
Kompilator informuje o błędzie \texttt{InconsistentConflictResolution} zawierającm:
\begin{itemize}
