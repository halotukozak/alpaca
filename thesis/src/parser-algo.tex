...
\noindent Algorytm iteruje po~wszystkich produkcjach, dodając:
...
\subsubsection{Algorytm rozstrzygania konfliktu}
...
\noindent W~przypadku braku reguły precedencji kompilator rzuca wyjątek zawierający:
\begin{itemize}
...
\textbf{Przykład:} Dla~gramatyki wyrażeń arytmetycznych z~reguł:
\begin{align*}
