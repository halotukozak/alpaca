...
\section[Dobór klasy parsera w systemie ALPACA]{Dobór klasy parsera w~systemie ALPACA}\label{sec:parser-algo-lr1}
...
\subsection[Zalety podejścia LR(1) w ALPACA]{Zalety podejścia LR(1) w~ALPACA}\label{subsec:parser-algo-lr1-pros}
