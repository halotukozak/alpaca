...
\lstinputlisting[language=c,caption={Fragment definicji parsera Ruby z~wykorzystaniem technologii Yacc},label={lst:ruby-parser}]{listings/introduction/01-ruby-parser.y}
