...
final class LexerTest extends AnyFunSuite with Matchers:
  ...
  test("tokenize simple identifier") {
    ...
    lexemes shouldBe List(Lexeme("IDENTIFIER", "hello", Map("text" -> "hello", "position" -> 6, "line" -> 1)))
  }
  ...
  test("throw exception for unexpected character") {
    ...
    exception.getMessage should include("Unexpected character: 'a'")
  }
